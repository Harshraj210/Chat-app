...
const GroupChatModal = ({ isOpen, onClose, setFetchAgain }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4 sm:p-6">
      <div className="bg-gray-800 p-4 sm:p-6 rounded-lg w-full max-w-md sm:max-w-lg text-white shadow-lg overflow-y-auto max-h-[90vh]">
            ...
            {selectedChat?.users?.map((u) => (
              ...
              >
                ...
                {u?._id === selectedChat?.groupAdmin?.user?._id && (
                  <span className="ml-2 text-xs text-yellow-300 font-bold">
                    (Admin)
                  </span>
                )}
